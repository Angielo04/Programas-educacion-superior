...
BEGIN
	CREATE TABLE dbo.DIM_Fechas (
		...
		CONSTRAINT DIM_Fechas_DIM_Dias_Semana_FK FOREIGN KEY (DiaSemana) REFERENCES dbo.DIM_Dias_Semana(DiaSemana),
		CONSTRAINT DIM_Fechas_DIM_Meses_FK FOREIGN KEY (Mes) REFERENCES dbo.DIM_Meses(Mes),
		CONSTRAINT DIM_Fechas_DIM_Trimestres_FK FOREIGN KEY (Trimestre) REFERENCES dbo.DIM_Trimestres(Trimestre)
	);
END;